...
const paths = {
  1: {
    ...
    date : "01/01/2022",
    checklists: [
      {checklist_id: 1, name: "Unité de soins", person: "Inf. de l'US qui prépare le patient ", fill: false, counter:false},
  ...
  2: {
    ...
    date : "01/01/2022",
    checklists: [
      {checklist_id: 1, name: "Unité de soins", person: "Inf. de l'US qui prépare le patient ", fill: true, counter:false },
...
const user_list = [
  {"id":1, user_code:"1234567", lastname: "Jonas", firstname: "Michel", role: "Assistant Anést." },
  {"id":2, user_code:"7654321", lastname: "Van Acker", firstname: "Denise", role: "Infirmière US" }
]
